 ...
 * that would otherwise depend on the platform linker resolving DT_NEEDED entries from the
 * application library directory. Nothing else in this file is changed. (Apache License 2.0,
 * section 4(b).)
 */
